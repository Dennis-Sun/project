...
#spark-submit ~/project/PartB_2.py /project/tmp/tmp_4g /project/output
#spark-submit ~/project/PartB_2.py /project/tmp/tmp_8g /project/output
#spark-submit ~/project/PartB_2.py /project/tmp/tmp_10g /project/output
#spark-submit ~/project/PartB_2.py /project/tmp/tmp_20g /project/output
#spark-submit ~/project/PartB_2.py /project/tmp/tmp_40g /project/output
#spark-submit ~/project/PartB_2.py /project/tmp/tmp_80g /project/output
end=$(date +%s)
