...
hadoop fs -rm -R /project/output/a2
rm intermediate/*
rm stats
...
start=$(date +%s)
spark-submit ~/project/PartA_2.py /project/tmp/tmp_$size /project/output/a2
#spark-submit ~/project/PartA_2.py /project/test/*.txt /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_1g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_2g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_4g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_8g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_10g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_20g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_40g /project/output
#spark-submit ~/project/PartA_2.py /project/tmp/tmp_80g /project/output
end=$(date +%s)
