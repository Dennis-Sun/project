...
public class TimeConsumer {
	...
	public static void main(String[] argv)throws Exception{
		...
		TimeConsumerThread consumerRunnable = new TimeConsumerThread(topicName,groupId);
	...
	private static class TimeConsumerThread extends Thread{
		...
		public TimeConsumerThread(String topicName, String groupId){
		...
		public void run() {
			...
			try {
				...
				String prefix = new String("/project/output/time/");
				...
				while (true) {
					...
					for (ConsumerRecord<String, String> record : records) {
						...
						Path file = new Path(prefix + hour);
						if ( fs.exists( file )) { 
