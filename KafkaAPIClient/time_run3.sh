...
java -cp ~/kafka_test/KafkaAPIClient/target/KafkaAPIClient-1.0-SNAPSHOT-jar-with-dependencies.jar com.spnotes.kafka.partition.TimeConsumer $1 group1 3 > ~/kafka_test/KafkaAPIClient/stdout_time.txt
