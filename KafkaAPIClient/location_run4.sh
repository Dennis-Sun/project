...
java -cp ~/kafka_test/KafkaAPIClient/target/KafkaAPIClient-1.0-SNAPSHOT-jar-with-dependencies.jar com.spnotes.kafka.partition.LocationConsumer $1 group2 4 > ~/kafka_test/KafkaAPIClient/stdout_location.txt
